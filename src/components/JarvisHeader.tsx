...
const JarvisHeader = ({ toggleSidebar }: { toggleSidebar: () => void }) => {
        ...
        <div className="flex items-center">
          <div className="h-8 w-8 mr-3 relative">
            ...
            <div className="absolute inset-1 bg-jarvis-dark rounded-full flex items-center justify-center">
              <span className="text-jarvis-blue text-xs font-mono">J</span>
            </div>
          </div>
          <div>
            <h1 className="font-bold text-xl jarvis-gradient-text">JARVIS</h1>
            <div className="flex items-center">
